...
print("CLOUDINARY_CLOUD_NAME (in settings.py):", cloudinary.config().cloud_name)
print("CLOUDINARY_API_KEY (in settings.py):", cloudinary.config().api_key)
print("CLOUDINARY_API_SECRET (in settings.py):", cloudinary.config().api_secret)
